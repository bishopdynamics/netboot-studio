...
FINAL_FILE='/tmp/unattend-windows-test.xml'

PROCESSOR_ARCH='amd64'
UI_LANGUAGE='en-US'
INPUT_LOCALE='0409:00000409'
USER_NAME='James'
USER_PASSWORD_PLAINTEXT='true'
USER_PASSWORD='p4ssw0rd'
USER_PRIMARY_GROUP='Administrators'
HOSTNAME="${USER_NAME}-Test-PC"
PRODUCT_KEY='W269N-WFGWX-YVC9B-4J6C9-T83GX'

SKIP_REARM='true' # boolint
ENABLE_LUA='true'
SKIP_AUTO_ACTIVATION='true'
CEIP_ENABLED='false' # boolint
DISABLE_AUTO_DAY_LIGHT_TIME_SET='false'
PROTECT_YOUR_PC='3' # int
